...
def scan(files): 
	...
	#Pulse_shift = str(tree.pulse_shift)
        ...
        #  CRRC90_ps_sr[0].append(tree.pulse_shift)
        #  CRRC90_ps_sr[1].append(tree.samplesReco.at(4))
    ...
    Plot_ps_sr.Plot(Last_nSmple, files, CRRC10_ps_sr, CRRC20_ps_sr, CRRC30_ps_sr, CRRC43_ps_sr, CRRC60_ps_sr, CRRC90_ps_sr, all_pulse_shift, all_samplesReco)
